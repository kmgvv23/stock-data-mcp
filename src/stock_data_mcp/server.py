...
mcp = FastMCP(
    ...
    instructions=(
        ...
        f"2. dart_get_financials_for_model(corp_code, years=[...]) → structured multi-year data\n"
        f"   IMPORTANT: years must always include current year {_today.year}. Never stop at prior year.\n"
